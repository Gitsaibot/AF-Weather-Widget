...
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_CLOUDY;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_PARTLYCLOUD;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_FAIR;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_RAINSHOWERANDTHUNDER;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_RAINSHOWERS;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_SLEETSHOWERS;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_SNOWSHOWERS;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_CLEARSKY;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_FOG;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_RAIN;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_HEAVYRAIN;
import static net.gitsaibot.af.AfUtils.WEATHER_ICON_HEAVYRAINANDTHUNDER;
...
public class AfNoaaWeatherData implements AfDataSource {
	...
	private final Map<String, Integer> mWeatherIconMap = new HashMap<>() {{
		/* Night icons */
		put("ntsra", WEATHER_ICON_HEAVYRAINANDTHUNDER);
		put("nscttsra", WEATHER_ICON_RAINSHOWERANDTHUNDER);
		put("ip", WEATHER_ICON_SLEET);
		put("nraip", WEATHER_ICON_SLEET);
		put("mix", WEATHER_ICON_SLEETSHOWERS);
		put("nrasn", WEATHER_ICON_SLEETSHOWERS);
		put("nsn", WEATHER_ICON_SNOWSHOWERS);
		put("fzra", WEATHER_ICON_SLEET);
		put("ip", WEATHER_ICON_SLEET);
		put("nra", WEATHER_ICON_HEAVYRAIN);
		put("hi_nshwrs", WEATHER_ICON_RAINSHOWERS);
		put("nra", WEATHER_ICON_RAIN);
		put("blizzard", WEATHER_ICON_SNOW);
		put("du", WEATHER_ICON_PARTLYCLOUD);
		put("fu", WEATHER_ICON_PARTLYCLOUD);
		put("nfg", WEATHER_ICON_FOG);
		put("nwind", WEATHER_ICON_PARTLYCLOUD);
		put("novc", WEATHER_ICON_CLOUDY);
		put("nbkn", WEATHER_ICON_PARTLYCLOUD);
		put("nsct", WEATHER_ICON_FAIR);
		put("nfew", WEATHER_ICON_FAIR);
		put("nskc", WEATHER_ICON_CLEARSKY);

		/* Day icons */
		put("tsra", WEATHER_ICON_HEAVYRAINANDTHUNDER);
		put("scttsra", WEATHER_ICON_RAINSHOWERANDTHUNDER);
		//put("ip", WEATHER_ICON_SLEET);
		put("raip", WEATHER_ICON_SLEET);
		//put("mix", WEATHER_ICON_DAY_POLAR_SLEETSUN);
		put("rasn", WEATHER_ICON_SLEETSHOWERS);
		put("sn", WEATHER_ICON_SNOWSHOWERS);
		//put("fzra", WEATHER_ICON_SLEET);
		//put("ip", WEATHER_ICON_SLEET);
		put("shra", WEATHER_ICON_HEAVYRAIN);
		//put("hi_shwrs", WEATHER_ICON_DAY_LIGHTRAINSUN);
		put("ra", WEATHER_ICON_RAIN);
		//put("blizzard", WEATHER_ICON_SNOW);
		//put("du", WEATHER_ICON_DAY_PARTLYCLOUD);
		//put("fu", WEATHER_ICON_DAY_PARTLYCLOUD);
		put("fg", WEATHER_ICON_FOG);
		put("cold", WEATHER_ICON_PARTLYCLOUD);
		put("hot", WEATHER_ICON_CLEARSKY);
		put("wind", WEATHER_ICON_PARTLYCLOUD);
		put("ovc", WEATHER_ICON_CLOUDY);
		put("bkn", WEATHER_ICON_PARTLYCLOUD);
		put("sct", WEATHER_ICON_FAIR);
		put("few", WEATHER_ICON_FAIR);
		put("skc", WEATHER_ICON_CLEARSKY);
	}};
